...
ALTER TABLE IF EXISTS Alocado
DROP CONSTRAINT FK_Alocado_Onibus_ID;
ALTER TABLE IF EXISTS Alocado
DROP CONSTRAINT FK_Alocado_Linha_ID;

ALTER TABLE IF EXISTS Ponto_de_Onibus
DROP CONSTRAINT FK_Ponto_de_Onibus_Endereco_ID;

ALTER TABLE IF EXISTS Percorre
DROP CONSTRAINT FK_Percorre_Linha_ID;
ALTER TABLE IF EXISTS Percorre
DROP CONSTRAINT FK_Percorre_Ponto_de_Onibus_ID;

ALTER TABLE IF EXISTS Passa
DROP CONSTRAINT FK_Passa_Onibus_ID;
ALTER TABLE IF EXISTS Passa
DROP CONSTRAINT FK_Passa_Ponto_de_Onibus_ID;

ALTER TABLE IF EXISTS Entrega
DROP CONSTRAINT FK_Entrega_Onibus_ID;
ALTER TABLE IF EXISTS Entrega
DROP CONSTRAINT FK_Entrega_Cliente_ID;

ALTER TABLE IF EXISTS Recebe
DROP CONSTRAINT FK_Recebe_Onibus_ID;
ALTER TABLE IF EXISTS Recebe
DROP CONSTRAINT FK_Recebe_Cliente_ID;

ALTER TABLE IF EXISTS Chega
DROP CONSTRAINT FK_Chega_Cliente_ID;
ALTER TABLE IF EXISTS Chega
DROP CONSTRAINT FK_Chega_Ponto_de_Onibus_ID;

ALTER TABLE IF EXISTS Deixa
DROP CONSTRAINT FK_Deixa_ClienteID;
ALTER TABLE IF EXISTS Deixa
DROP CONSTRAINT FK_Deixa_Ponto_de_Onibus_ID;
